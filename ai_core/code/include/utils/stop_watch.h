...
#ifndef DNN_AI_BENCHMARK_CODE_INCLUDE_UTILS_STOP_WATCH_H_
#define DNN_AI_BENCHMARK_CODE_INCLUDE_UTILS_STOP_WATCH_H_
...
#endif  // DNN_AI_BENCHMARK_CODE_INCLUDE_UTILS_STOP_WATCH_H_
