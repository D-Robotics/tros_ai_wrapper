...
#ifndef DNN_AI_BENCHMARK_CODE_INCLUDE_UTILS_ALGORITHM_H_
#define DNN_AI_BENCHMARK_CODE_INCLUDE_UTILS_ALGORITHM_H_
...
#endif  // DNN_AI_BENCHMARK_CODE_INCLUDE_UTILS_ALGORITHM_H_
