...
#ifndef DNN_AI_BENCHMARK_CODE_INCLUDE_METHOD_METHOD_DATA_H_
#define DNN_AI_BENCHMARK_CODE_INCLUDE_METHOD_METHOD_DATA_H_
...
#endif  // DNN_AI_BENCHMARK_CODE_INCLUDE_METHOD_METHOD_DATA_H_
