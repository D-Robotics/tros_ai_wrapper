...
#ifndef DNN_AI_BENCHMARK_CODE_INCLUDE_METHOD_POST_PROCESS_METHOD_H_
#define DNN_AI_BENCHMARK_CODE_INCLUDE_METHOD_POST_PROCESS_METHOD_H_
...
#endif  // DNN_AI_BENCHMARK_CODE_INCLUDE_METHOD_POST_PROCESS_METHOD_H_
