...
#ifndef DNN_AI_BENCHMARK_CODE_INCLUDE_METHOD_METHOD_FACTORY_H_
#define DNN_AI_BENCHMARK_CODE_INCLUDE_METHOD_METHOD_FACTORY_H_
...
#endif  // DNN_AI_BENCHMARK_CODE_INCLUDE_METHOD_METHOD_FACTORY_H_
