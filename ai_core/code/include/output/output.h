...
#ifndef DNN_AI_BENCHMARK_CODE_INCLUDE_OUTPUT_OUTPUT_H_
#define DNN_AI_BENCHMARK_CODE_INCLUDE_OUTPUT_OUTPUT_H_
...
class OutputModule {
 ...
 protected:
  std::function<void(const std::vector<cv::Mat>& imgs, ImageTensor *frame, Perception *perception)> get_render_imgs_func_ = nullptr;
...
#endif  // DNN_AI_BENCHMARK_CODE_INCLUDE_OUTPUT_OUTPUT_H_
