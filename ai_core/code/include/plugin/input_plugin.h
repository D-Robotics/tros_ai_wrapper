...
#ifndef DNN_AI_BENCHMARK_CODE_INCLUDE_PLUGIN_INPUT_PLUGIN_H_
#define DNN_AI_BENCHMARK_CODE_INCLUDE_PLUGIN_INPUT_PLUGIN_H_
...
class InputProducerPlugin : public BasePlugin {
 public:
  ...
  int Release(ImageTensorPtr msg);
...
#endif  // DNN_AI_BENCHMARK_CODE_INCLUDE_PLUGIN_INPUT_PLUGIN_H_
