...
#ifndef DNN_AI_BENCHMARK_CODE_INCLUDE_INPUT_BATCH_IMAGE_LIST_DATA_ITERATOR_H_
#define DNN_AI_BENCHMARK_CODE_INCLUDE_INPUT_BATCH_IMAGE_LIST_DATA_ITERATOR_H_
...
class BatchImageListDataIterator : public DataIterator {
 public:
  BatchImageListDataIterator()
      : DataIterator("batch_image_list_data_iterator") {}
  ...
  ~BatchImageListDataIterator() override;
 ...
 private:
  ...
  std::vector<std::string> image_list_file_{};
  std::vector<std::vector<std::string>> image_files_{};
...
#endif  // DNN_AI_BENCHMARK_CODE_INCLUDE_INPUT_BATCH_IMAGE_LIST_DATA_ITERATOR_H_
