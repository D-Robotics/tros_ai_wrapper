...
#ifndef DNN_AI_BENCHMARK_CODE_INCLUDE_INPUT_BATCH_DATA_ORIGIN_ITERATOR_H_
#define DNN_AI_BENCHMARK_CODE_INCLUDE_INPUT_BATCH_DATA_ORIGIN_ITERATOR_H_
...
class BatchDataOriginIterator : public DataIterator {
 public:
  BatchDataOriginIterator() : DataIterator("batch_data_iterator") {}
  ...
  ~BatchDataOriginIterator() override;
...
#endif  // DNN_AI_BENCHMARK_CODE_INCLUDE_INPUT_BATCH_DATA_ORIGIN_ITERATOR_H_
