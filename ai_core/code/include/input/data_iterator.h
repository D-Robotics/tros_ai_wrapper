...
#ifndef DNN_AI_BENCHMARK_CODE_INCLUDE_INPUT_DATA_ITERATOR_H_
#define DNN_AI_BENCHMARK_CODE_INCLUDE_INPUT_DATA_ITERATOR_H_
...
class DataIterator {
 public:
   ...
   * @return 0 if success
   */
  virtual int Init(std::string config_string);
...
#endif  // DNN_AI_BENCHMARK_CODE_INCLUDE_INPUT_DATA_ITERATOR_H_
