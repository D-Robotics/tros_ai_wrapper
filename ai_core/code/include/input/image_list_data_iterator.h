...
#ifndef DNN_AI_BENCHMARK_CODE_INCLUDE_INPUT_IMAGE_LIST_DATA_ITERATOR_H_
#define DNN_AI_BENCHMARK_CODE_INCLUDE_INPUT_IMAGE_LIST_DATA_ITERATOR_H_
...
#endif  // DNN_AI_BENCHMARK_CODE_INCLUDE_INPUT_IMAGE_LIST_DATA_ITERATOR_H_
