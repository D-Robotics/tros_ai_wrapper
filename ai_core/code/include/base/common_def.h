...
#ifndef DNN_AI_BENCHMARK_CODE_INCLUDE_BASE_COMMON_DEF_H_
#define DNN_AI_BENCHMARK_CODE_INCLUDE_BASE_COMMON_DEF_H_
...
#endif  // DNN_AI_BENCHMARK_CODE_INCLUDE_BASE_COMMON_DEF_H_
